...
1. Claude 在 CL-006 worktree 只实现任务卡范围；完成代码、截图、测试、commit、交接与 STATUS 后立即停止，Codex 独立验收。
2. Codex 验收 CL-006 后在 iOS 27 Simulator 复验首页/搜索/发布/帮助/我的、AG-007 进度/交付入口与冷暖启动；无公开故事 API 时运行态保持诚实空态。
