...
final class WishListViewModelTests: XCTestCase {
    ...
    func testRaceCondition_LateFailure() async throws {
        ...
        await mockAPI.completeRequest("杭州", with: .failure(GratiaAPIError.requestCancelled))
        await taskA.value
    ...
    func testCallerTaskCancellationPropagation() async throws {
        ...
        await mockAPI.completeRequest("北京", with: .failure(GratiaAPIError.requestCancelled))
