        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: DesignSystem.spacing16) {
                    ...
                    informationCard(
                        title: "举报与屏蔽",
                        body: "在任何一段私聊里点右上角「⋯」，可以举报对方或直接屏蔽。举报后我们会人工查看该会话并处理，通常在 24 小时内响应。屏蔽是立即生效的，不需要等待审核：屏蔽后双方都无法再在那段对话里发消息，但对话与历史记录会保留，你也可以随时取消屏蔽。你还可以发邮件到 hansel.zzh@gmail.com 举报。"
                    )
                    informationCard(
                        title: "隐私声明",
